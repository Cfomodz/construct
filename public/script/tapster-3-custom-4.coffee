...
part
  name: 'product-assembly-shell'
  source: '3d/custom/low-poly-device.stl'
  color: 0x880000
  transparent: false
  opacity: 0.6
  visible: true
  translate: [0, 0, 21 + 120 - 21.79]
  rotate: [0, 0, 0]
...
part
  ...
  visible: true
  # box size: width, length, height
  size: [100,100,120 - 21.79]
  translate: [0, 0, 21 + ((120 - 21.79) / 2)]
  rotate: [0, 0, 0]
...
part
  ...
  # box size: width, length, height
  size: [40, 150, 20]
  translate: [0, 150/2 - 23, (20/2) + 20 + ceiling + 60]
  rotate: [0, 0, 0]

part
  name: 't-slot-2020-phone-holder'
  shape: 'box'
  color: 0x333333
  transparent: false
  opacity: 0.9
...
part
  ...
  # box size: width, length, height
  size: [40, 20, 254 + 60]
  translate: [0, 254/2 + 20/2, 20 + ((254 + 60)/2) + 1]
  rotate: [0, 0, 0]

part
  name: 'lower-frame-cover'
  source: '3d/tapster-3/lower-frame-cover-v2.stl'
  color: 0x444444
  transparent: false
  opacity: 1
  visible: true
  translate: [-20, 254/2 + 20, 1 - 20]
  rotate: [0, -90, 180]

part
  name: 'lower-frame-cover-mirror'
  source: '3d/tapster-3/lower-frame-cover-mirror-v2.stl'
  color: 0x444444
  transparent: false
  opacity: 1
  visible: true
...
part
  name: 'upper-frame-corner'
  source: '3d/tapster-3/upper-frame-corner.stl'
  color: 0x444444
  transparent: false
  opacity: 1
  visible: true
  translate: [0, 254/2 + 20, ceiling + 40 + 60]
  rotate: [180, 0, 0]
...
group
  ...
  translate: [0, -13, 20 + 60]
  rotate: [0, 0, 0]
  visible: true
  parts: [
    {
    name: 'base'
    source: '3d/tapster-3/cap.stl'
    color: 0xDF1F1F
    translate: [0, 0, ceiling + 20]
    rotate: [0, 180, 180]
    visible: true
    }
    {
    ...
    group:
      ...
      parts: [
        ...
        {
        name: 'pen-holder'
        source: '3d/tapster-3/pen-holder.stl'
        translate: [0, 0, 5]
        rotate: [0, 0, 120]        
        color: 0xDF1F1F
        }
        {
        name: 'stylus'
        source: '3d/tapster-3/resistive-stylus.stl'
        translate: [0, 0, 30]
        rotate: [0, 180, 30]        
        color: 0x222222
        }                  
