...
part
  name: 'button-pusher'
  source: '3d/tapster-3/powerbot-assembly.stl'
  color: 0xDF1F1F
  transparent: false
  opacity: 0.6
  visible: true
...
part
  ...
  # box size: width, length, height
  size: [40, 190 + 100, 20]
  translate: [0, 190/2 - 5 - 100/2, (20/2) + 1 + ceiling + 10]
  rotate: [0, 0, 0]
...
part
  ...
  visible: true
  # box size: width, length, height
  size: [40, 20, ceiling + 10]
  translate: [0, 350/2 + 10 + 10, ((ceiling + 10) / 2) + 1 ]
  rotate: [0, 0, 0]
...
part
  ...
  translate: [0, 0, (6.4/2) + .7 + 40]
  rotate: [0, 0, 0]

part
  name: 'samsung-galaxy-tab-a12'
  shape: 'box'
  color: 0x666666
  transparent: false
  opacity: 0.8
